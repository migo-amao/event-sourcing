...
import wei.listener.PaymentConsumer;
...
public class KafkaConfig {
    ...
    public KafkaConsumer<String, Order> kafkaConsumer() {
        ...
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, "payment.consumer.id." + UUID.randomUUID().toString());
    ...
    public KafkaProducer<String, String> kafkaProducer() {
        ...
        producerProperties.put(ProducerConfig.CLIENT_ID_CONFIG, "payment.id.producer." + UUID.randomUUID().toString());
        producerProperties.put(ProducerConfig.TRANSACTIONAL_ID_CONFIG, "tx.payment.id.producer." + UUID.randomUUID().toString());
